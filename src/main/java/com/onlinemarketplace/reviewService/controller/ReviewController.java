...
public class ReviewController {
    ...
    public ResponseEntity<ReviewResponseObject> createReviews( @PathVariable(name ="productId")String productId,  @RequestBody ReviewRequestObject reviewRequestObject) {
    ...
    public ResponseEntity<ReviewResponseObject> updateReviews( @PathVariable(name ="productId")String productId, @RequestBody ReviewRequestObject reviewRequestObject, @PathVariable(name = "reviewId") String reviewId) {
